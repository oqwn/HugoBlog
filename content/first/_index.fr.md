...
* [Recherche automatique]({{%relref "first/basics/configuration/_index.md#activer-recherche" %}})
* [Mode multi-langue]({{%relref "first/cont/i18n/_index.md" %}})
...
* [Taille d'image, ombres...]({{%relref "first/cont/markdown.fr.md#images" %}})
* [Fichiers joints]({{%relref "first/shortcodes/attachments.fr.md" %}})
* [Lister les pages filles]({{%relref "first/shortcodes/children/_index.md" %}})
* [Diagrammes Mermaid]({{%relref "first/shortcodes/mermaid.fr.md" %}}) (flowchart, sequence, gantt)
* [Style configurable and variantes de couleurs]({{%relref "first/basics/style-customization/_index.md"%}})
* [Boutons]({{%relref "shortcodes/button.fr.md" %}}), [Messages Astuce/Note/Info/Attention]({{%relref "first/shortcodes/notice.fr.md" %}}), [Expand]({{%relref "first/shortcodes/expand.fr.md" %}})
